...
class AbsTask(ABC):
    ...
    def main_worker(cls, args: argparse.Namespace):
        ...
        if args.dry_run:
            ...
            if len(args.valid_shape_file) != 0:
                ...
                valid_key_file = None
            logging.info(f"args.data_path_and_name_and_type is {args.train_data_path_and_name_and_type}")
            collect_stats(
                model=model,
    ...
    def build_streaming_iterator(
        ...
        logging.info(f"data_path_and_name_and_type is {data_path_and_name_and_type}")
