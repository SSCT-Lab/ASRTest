  ...
  (att_list): ModuleList(
    (0): AttLoc(
      ...
      (gvec): Linear(in_features=320, out_features=1, bias=True)
        ...
        for k, d in self.full_scorers.items():
            count += 1
            logging.info(f"count is {count}, k is {k}, d is {d}")
            scores[k], states[k], ginis[k] = d.score(hyp.yseq, hyp.states[k], x)
        return scores, states, ginis
    ...
    def search(
        ...
        for hyp in running_hyps:
            ...
            scores, states, ginis = self.score_full(hyp, x)
            print("scores", scores)
            print("ginis", ginis)
        ...
        print("the length of best_hyps:", len(best_hyps))
        return best_hyps
