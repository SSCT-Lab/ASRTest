...
def get_parser():
    ...
    parser.add_argument("--orig_flag", type=str, default="False")
...
def main(args):
    ...
    orig_flag = str_2_bool(args.orig_flag)
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    if need_decode:
                        ...
                        recog_v2(args, orig_flag)
                    else:
                        new_dir = "/".join(args.result_label.split("/")[0:-1])
                        orig_dir = new_dir.replace("new", "orig")
                        aug_type = args.recog_set.split("-")[-1]
                        gini_audio = sort_test_by_gini_v1(args.orig_dir, new_dir, aug_type)
                        test_data_prep("data/test-orig", "data/" + args.recog_set, "ted2", gini_audio, "gini", 1155, args.recog_set)
